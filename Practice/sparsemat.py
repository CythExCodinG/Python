# Function to get column-wise representation of sparse matrix
def sparse_matrix_representation(matrix):
    ...
    # Traverse the matrix
    for j in range(columns):  # Column-wise traversal
        for i in range(rows):
...
print("Column-wise Sparse Matrix Representation (row, column, value):")
